	...
	<body>
		<div class="admin-biaogelist">
			<div class="listbiaoti am-cf">
				...
				<dl class="am-icon-home" style="float: right;">
					当前位置： 首页 > 
						<a href="offCourse.php?action=show">{$title}</a>
		...
		{if $update}
			...
			<input type="hidden" value="{$id}" name="id">
				<div class="form-group">
					<label>课程名称</label>
					<input type="name" value="{$name}" class="form-control" name="name" placeholder="请输入您的课程名称">
				</div>
				<div class="form-group">
					<label>授课时间</label>
					<input type="name" value="{$tranning_date}" class="form-control" name="tranning_date"  placeholder="请输入授课时间" id=datetimepicker_format>
				</div>
				<div class="form-group">
					<label>授课地点</label>
					<input type="name" value="{$address}" class="form-control"  name="address"  placeholder="请输入授课地点">
				</div>
				<div class="form-group">
					<label>主办方</label>
					<input type="name" value="{$sponsor}" class="form-control"  name="sponsor"  placeholder="请输入主办方">
				</div>
				<div class="form-group">
					<label>承办方</label>
					<input type="name" value="{$organizer}" class="form-control"  name="organizer"  placeholder="请输入承办方">
				</div>
				<input  type="submit" value="保存"  class="submit" name="send">
			</form>
		{/if}
