	...
	<body>
		<div class="admin-biaogelist">
			<div class="listbiaoti am-cf">
				...
				<dl class="am-icon-home" style="float: right;">
					当前位置： 首页 > <a href="user.php?action=show">详情查看</a>
				</dl>
			</div>
		</div>
		<div class="appointment" style="margin-top:35px;">
						...
						<tr class="active">
							...
							<div class="form-group">
								<label class="radio-inline">
									<input type="radio"  value="<?php echo $value->nickname?>" name="<?php echo $value->nickname?>">
									是 </label>
								<label class="radio-inline">
									<input type="radio"  value="<?php echo $value->nickname?>" name="<?php echo $value->nickname?>" checked="checked">
									否 </label>
							</td>
							<td><a href="?action=delete&id=<?php echo $value->id?>" onClick="return confirm('您真的要删除这位报名者吗？') ? true:false;">删除</a></td>
						</tr>
						<?php } ?>
						<?php } else { ?>
						<tr class="active">
				...
				<div class="page" style="width:30%">
					<ul class="pagination pagination-sm">
						<button class="btn btn-default" style="float:left;height:30px;margin-right:5px;line-height:10px;">
							<a href="../config/excel.php?id=<?php echo $this->_vars['id'];?>">下载</a>
						</button>
			...
			<div class="panel-body">
				...
				<?php if(@$this->_vars['meetManage']) {?>
				<?php foreach ($this->_vars['meetManage'] as $key=>$value) { ?>
				<table class="table table-bordered table-hover table-condensed">
					<thead>
						<tr>
							<th>阶段</th>
